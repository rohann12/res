...
@section('heading', 'Clients and Partners')
@section('subheading', 'All clients and partners')
...
<div class="relative overflow-x-auto  shadow-md sm:rounded-lg" style="min-height: 400px;">
    <table class="w-full text-sm  text-left rtl:text-right text-gray-500 ">
        ...
        <tbody>
                    ...
                    <form action="{{ route('client.destroy', ['client' => $client]) }}" method="post">
                        ...
                        <button type="submit" value="Delete"
                            ...
                            {{-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px">
                                <path class="fill-current text-gray-900 hover:text-red-600"
            ...
            @empty
            <tr class="bg-white border-b  hover:bg-gray-50 ">
                <td scope="row" class="px-6 py-1 font-medium text-gray-900 whitespace-nowrap " colspan="5">
                    No clients to show
                </td>
            </tr>
            @endforelse
